                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <div class="collapse navbar-collapse main-menu-item justify-content-end"
                            ...
                            <ul class="navbar-nav align-items-center">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="cource.html">Cursos</a>
                                </li>
                                <li class="nav-item">
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | <i class="ti-heart" aria-hidden="true"></i> by <a href="https://loginweb.dev" target="_blank">LoginWeb</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <!-- swiper js -->
    <script src="{{ asset('vendor/inti/vendor/inti/js/slick.min.js') }}"></script>
