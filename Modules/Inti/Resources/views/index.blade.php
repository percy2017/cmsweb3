...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="vendor/inti/css/bootstrap.min.css">
    <!-- animate CSS -->
    <link rel="stylesheet" href="vendor/inti/css/animate.css">
    <!-- owl carousel CSS -->
    <link rel="stylesheet" href="vendor/inti/css/owl.carousel.min.css">
    <!-- themify CSS -->
    <link rel="stylesheet" href="vendor/inti/css/themify-icons.css">
    <!-- flaticon CSS -->
    <link rel="stylesheet" href="vendor/inti/css/flaticon.css">
    <!-- font awesome CSS -->
    <link rel="stylesheet" href="vendor/inti/css/magnific-popup.css">
    <!-- swiper CSS -->
    <link rel="stylesheet" href="vendor/inti/css/slick.css">
    <!-- style CSS -->
    <link rel="stylesheet" href="vendor/inti/css/style.css">
</head>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <!-- jquery plugins here-->
    <!-- jquery -->
    <script src="vendor/inti/js/jquery-1.12.1.min.js"></script>
    <!-- popper js -->
    <script src="vendor/inti/js/popper.min.js"></script>
    <!-- bootstrap js -->
    <script src="vendor/inti/js/bootstrap.min.js"></script>
    <!-- easing js -->
    <script src="vendor/inti/js/jquery.magnific-popup.js"></script>
    <!-- swiper js -->
    <script src="vendor/inti/js/swiper.min.js"></script>
    <!-- swiper js -->
    <script src="vendor/inti/js/masonry.pkgd.js"></script>
    <!-- particles js -->
    <script src="vendor/inti/js/owl.carousel.min.js"></script>
    <script src="vendor/inti/js/jquery.nice-select.min.js"></script>
    <!-- swiper js -->
    <script src="vendor/inti/vendor/inti/js/slick.min.js"></script>
    <script src="vendor/inti/js/jquery.counterup.min.js"></script>
    <script src="vendor/inti/js/waypoints.min.js"></script>
    <!-- custom js -->
    <script src="vendor/inti/js/custom.js"></script>
</body>
