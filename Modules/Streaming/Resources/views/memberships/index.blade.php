    ...
    <h1 class="page-title">
      ...
      <div class="btn-group">
        ...
        <ul class="dropdown-menu">
          <li><a href="#list" onclick="ajax('{{ route('memberships_ajax_list') }}', 'get')">Paginacion de:{{ setting('admin.pagination') }}</a></li>
          <li><a href="#elimnados" id="eliminados">Mostrar Elimnados</a></li>
          <li role="separator" class="divider"></li>
          <li><a href="#create" onclick="ajax('{{ route('voyager.'.$dataType->name.'.create') }}', 'get')">Nuevo</a></li>
          <li><a href="{{ route('voyager.bread.edit', $dataType->slug) }}" target="_blank">Configuracion</a></li>
        </ul>
      </div>
  </div>
@stop
...
@section('javascript')
    ...
    <script>
      $(document).ready(function () {
          ajax('{{ route('memberships_ajax_list') }}', 'get');
