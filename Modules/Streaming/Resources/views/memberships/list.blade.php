                            ...
                            <tr id="{{ $data->id }}">
                              ...
                              @endforeach
                                ...
                                <td class="no-sort no-click bread-actions">
                                    <a href="#editando" onclick="ajax('{{ route('voyager.memberships.edit', $data->id) }}', 'get')" title="#" class="btn btn-primary">
                                      <i class="voyager-edit"></i> <span class="hidden-xs hidden-sm">Editar</span>
                                    </a>
                                  
                                    <a href="#eliminando" onclick="ajax('{{ route('voyager.memberships.destroy', $data->id) }}', 'delete')" title="Eliminar" class="btn btn-danger">
