<div class="row">
    <div class="col-md-12">
        <form class="myform" role="form" action="{{ route('myaccounts_ajax_profile_store') }}" id="myform" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
                        ...
                        @case('relationship')
                            ...
                            @if($row->details->{'type'} == 'belongsTo')
                                ...
                                @else
                                    ...
                                    <input type="text" name="{{ $row->field }}" disabled />    
                                @endif
                            @break
